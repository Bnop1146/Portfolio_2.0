...
<div class="how-section1">
    <div class="row">
        <div class="col-md-6 how-img">
            <img src="images/Monzo.jpg" class="rounded-circle img-fluid" alt=""/>
        </div>
        <div class="col-md-6">
            <h4>Monzo</h4>
            <h4 class="subheading">Musik video og Landing page</h4>
            <p class="text-muted text-lowercase">TIL DISSE TO FRISKE FYRE, FIK MIN GRUPPE OG JEG LAVET EN SUPER FED
                MUSIK VIDEO, OG EN YDERST ATRAKTIV FRONTPAGE HJEMMESIDE. SOM SKULLE HJÆLPE DEM MED AT ANSKAFFE FLERE
                FANS

                .Det var en fornøjelse at arbejde sammen med disse 2 gutter, med der flamboyante ideer og energiske være
                måde.</p>
        </div>
    </div>
</div>
