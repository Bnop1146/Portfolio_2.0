    ...
    <nav class="nav bd-grid">
        <div>
            <a href="index.html" class="nav__logo">
                <img src="images/Logo.png" style="width: 30px" class="d-inline-block text-decoration-none align-top"
                     alt="">
                Joachim Berner
            </a>
        </div>
...
<div class="how-section1">
    <div class="row">
        <div class="col-md-6 how-img">
            <img src="images/kafetårn.jpg" class="rounded-circle img-fluid " alt=""/>
        </div>
        <div class="col-md-6">
            <h4>Cafe Kaffetår'n</h4>
            <h4 class="subheading">Seo optimering, SoMe, Video og billeder
                freelance business.</h4>
            <p class="text-muted"> Her har vi en opgave hvor vi skulle Seo Optimere for en Cafe ejer,
                som mente at hun manglede kunder i hendes cafe, dette var en af de lidt sværere opgaver da ejeren ikke
                helt selv vidste
                hvad hun ønskede med cafen. Men vi gjorde vores bedste for at hjælpe hende, ved f.eks. at Modernisere
                hendes Brand med Logo, Videoer og billeder som kunne
                bruges på de sociale medier.
                der udover opsatte vi også en en hjemmeside til hende, for ydeligere formidling til hendes kunder.
            </p>
        </div>
    </div>
</div>
